...
fn bitboard_ops() {
    ...
    let all_white = bitboard::WHITE_START_PAWNS | bitboard::WHITE_START_ROOKS
        | bitboard::WHITE_START_KNIGHTS | bitboard::WHITE_START_BISHOPS
        | bitboard::WHITE_START_QUEENS | bitboard::WHITE_START_KINGS;
