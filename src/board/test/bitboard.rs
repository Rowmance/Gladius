...
fn bitboard_ops() {
    ...
    assert_eq!(white_pieces & bitboard::WHITE_START_PAWNS, BitBoard::empty());
...
#[test]
fn bitboard_flip() {
    assert_eq!(bitboard::WHITE_START_PAWNS.flip(), bitboard::BLACK_START_PAWNS);
    assert_eq!(bitboard::WHITE_START_ROOKS, bitboard::BLACK_START_ROOKS.flip());
    ...
    assert_eq!(bitboard::WHITE_START_QUEENS, bitboard::BLACK_START_KINGS.flip());
    assert_eq!(bitboard::WHITE_START_KINGS.flip(), bitboard::BLACK_START_QUEENS);
}
...
fn bitboard_mirror_horizontal() {
    ...
    assert_eq!(
        ...
        bitboard::WHITE_START_BISHOPS.mirror_horizontal().mirror_horizontal()
    );
